...
const Sidebar = () => {
  const navItems = [
    ...
    { id: 'staff', label: 'POS (New Order)', path: '/staff', icon: <FaPrint /> },
    { id: 'inventory', label: 'Inventory', path: '/inventory', icon: <FaBoxesStacked /> },
    { id: 'services', label: 'Services', path: '/services', icon: <FaPrint /> },
    { id: 'expenses', label: 'Expenses', path: '/expenses', icon: <FaGears /> },
